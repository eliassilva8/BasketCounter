...
public class MainActivity extends AppCompatActivity {
    ...
    int mScoreLeftTeam = 0;
    int mScoreRightTeam = 0;
    int mFoulsLeftTeam = 0;
    int mFoulsRightTeam = 0;
    long mQuarterTime = 0;
    int mBonusSituation = 0;
    int mOverBonus = 0;
     ...
     */
    public void displayScoreLeftTeam(int score) {
        TextView scoreView = findViewById(R.id.tv_score_left);
        scoreView.setText(String.valueOf(score));
    }

    public void displayScoreRightTeam(int score) {
        TextView scoreView = findViewById(R.id.tv_score_right);
        scoreView.setText(String.valueOf(score));
    }

    public void displayFoulsLeftTeam(int fouls) {
        tvFoulsLeft.setText(String.valueOf(fouls));
    }

    public void displayFoulsRightTeam(int fouls) {
